...
class Company extends \App\Entity\Company implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Company' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Company' . "\0" . 'code', '' . "\0" . 'App\\Entity\\Company' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Company' . "\0" . 'description'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCode(string $code): \App\Entity\Company
    {
