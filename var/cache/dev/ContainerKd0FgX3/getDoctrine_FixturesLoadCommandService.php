...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/CandidatsFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/JobFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/RecruteurFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\CandidatsFixtures($b), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\JobFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\RecruteurFixtures($b), 'groups' => []]]);
