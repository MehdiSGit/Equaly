...
class getSecurity_Authentication_Provider_Guard_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.authentication.provider.guard.main'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\Security\\CandidatRecruteurAuthenticator'] ?? $container->load('getCandidatRecruteurAuthenticatorService'));
        }, 1), ($container->privates['security.user.provider.concrete.candidat_recruteur_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_CandidatRecruteurProviderService')), 'main', new \Symfony\Component\Security\Core\User\UserChecker(), ($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService')));
    }
}
